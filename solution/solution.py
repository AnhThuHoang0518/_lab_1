...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_cost_estimate = (
        ...
        / 1000
        * COST_PER_1K_OUTPUT_TOKENS[OPENAI_MODEL]
    )
    mini_estimated_output_tokens = len(mini_response.split()) / 0.75
    mini_cost_estimate = (
        mini_estimated_output_tokens
        / 1000
        * COST_PER_1K_OUTPUT_TOKENS[OPENAI_MINI_MODEL]
    )
...
compare_models.__module__ = "template"
